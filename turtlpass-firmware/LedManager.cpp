...
void LedManager::setup() {
  FastLED.addLeds<LED_TYPE, LED_PIN, COLOR_ORDER>(leds, NUM_LEDS).setCorrection(TypicalSMD5050);  // https://github.com/FastLED/FastLED/wiki/FastLED-Color-Correction
